                            ...
                            <tbody>
                                <tr v-for="(item,index) in teachers" :key="index">
                                    ...
                                    <td>
                                        ...
                                        <button @click="assign(item)" class="btn btn-info p-1 text-white"> <i class="fa fa-plus"></i> Asignar </button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<!--                                    <button @click="plan(item)" class="btn btn-warning p-1"> <i class="fa fa-address-book-o"></i> Plan materia </button>-->
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<!--                                    <select name="curso"  v-model="curso" required class="form-control">-->
<!--                                        <option value="">Seleccionar..</option>-->
<!--                                        <option v-for="item in cursos" v-bind:value="item.id" >{{item.nombre}}</option>-->
<!--                                    </select>-->
                                </div>
